function model = single_experiment(tfpr, data_name, test_repeat, optimized_params)
    ...
    hyperparam_space = utility_functions.generate_hyperparameter_space_Tree_OLNP(hyperparams);
        ...
        if hyperparam_number>1
            ...
            for i=1:length(hyperparam_space)
                ...
                parfor j=1:cross_val_MC
                    ...
                    % load the model
                    model = Tree_OLNP(eta_init, beta_init, gamma, sigmoid_h, lambda, tree_depth, split_prob, node_loss_constant, n_features, tfpr);
